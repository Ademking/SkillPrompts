...
const Logo = (props) => (
    ...
    >
        <g>
            <path
                fill="#0b78ff"
                d="M33.95 15.556a2 2 0 0 0-3.9 0l-1.107 4.867a6 6 0 0 1-4.52 4.52l-4.866 1.107a2 2 0 0 0 0 3.9l4.866 1.107a6 6 0 0 1 4.52 4.52l1.107 4.866a2 2 0 0 0 3.9 0l1.107-4.866a6 6 0 0 1 4.52-4.52l4.867-1.107a2 2 0 0 0 0-3.9l-4.867-1.107a6 6 0 0 1-4.52-4.52z"
                opacity={1}
